...
# Create probabilities with Goals scored in matches played      #NOTE: NHL Standings are scored as followed: 2pts for Wins, 1 Pts for OT Win, and 1PT for Shootout Loss. For Simplicity we will just score assign 1 Pts for a win and disregard OT & SO.
```{r}
